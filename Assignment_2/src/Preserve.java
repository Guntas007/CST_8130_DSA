...
public class Preserve extends FoodItem {
    ...
    public Preserve(int itemCode, String name, int itemQuantityInStock, double cost, double salesPrice, String jarSizeInMl) {
     ...
     *
     * @return A string containing the item code, name, quantity in stock, sales price, cost, and jar size in milliliters.
     */
    @Override
    public String toString() {
        return String.format("Item: %d %s %d price: $%.2f cost: $%.2f size: %d mL",
                getItemCode(), getName(), getItemQuantityInStock(), getSalesPrice(), getCost(), jarSizeInMl);
    }
