...
public class FoodItem implements Comparable<FoodItem> {
     ...
     * @return A negative integer, zero, or a positive integer as this FoodItem is less than, equal to, or greater than the other.
     */
    @Override
     ...
     *
     * @return A string containing the item code, name, quantity in stock, sales price, and cost.
     */
    @Override
    public String toString() {
        return String.format("Item: %d %s %d price: $%.2f cost: $%.2f", getItemCode(), getName(), getItemQuantityInStock(), getSalesPrice(), getCost());
    }
