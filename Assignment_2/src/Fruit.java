...
public class Fruit extends FoodItem {
     ...
     *
     * @return A string containing the item code, name, quantity in stock, sales price, cost, and orchard name.
     */
    @Override
    public String toString() {
        return String.format("Item: %d %s %d price: $%.2f cost: $%.2f orchard supplier: %s",
                getItemCode(), getName(), getItemQuantityInStock(), getSalesPrice(), getCost(), orchardName);
    }
